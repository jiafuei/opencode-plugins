...
- If a native compact request fails, the current request falls back to the previous usable window or original history, and native compaction is disabled for the rest of that user turn. A new user message or model change allows another attempt.
