...
Summaries are concise, one-line retrieval descriptions of the topic's coverage and distinctive terms, not substitutes for the facts. Topic bodies use as much space as needed to preserve useful conditions, exceptions, and rationale, in short paragraphs or bullets. Neither summaries nor bodies have arbitrary character or byte limits. Meaningful dates may remain in the body; the plugin separately records when the topic was written.
